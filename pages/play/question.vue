...
export default {
  ...
  data() {
    return {
      answersType: this.$t("addQuestionPage.questionTypes.oneAnswer"),
      answers: [
        {
          ansText: "1967",
          imageUrl: "",
      ...
      value: 100,
      questionText: "في أي عام قامت حرب السادس من أكتوبر ؟",
      QuestionOrder: 1, // current question order
      Questions: 10, // total questions
      score: 150, // player score
      QuestionImgSrc:
        "https://www.albayan.ae/polopoly_fs/1.3673154.1570979215!/image/image.jpg",
    };
  },
  mounted() {
    // Timer Function
